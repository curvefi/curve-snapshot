...
balances = balances[0] * lp_stakedao_supply / lp_total_supply, balances[1] * lp_stakedao_supply / lp_total_supply

eth_per_lp, crv_per_lp = balances[0] / lp_stakedao_supply, balances[1] / lp_stakedao_supply
...
with open("data/crveth/stakedao_snapshot.csv", "w", newline="") as file:
    writer = csv.writer(file)
    writer.writerows(data)

with open("data/crveth/stakedao_overall.csv", "w", newline="") as file:
    writer = csv.writer(file)
    writer.writerows(
        [
            [

...
convex_addr = "0x14DC104D74372527fEC45b86E87Fe263C7215369"
...
with open(
    Path(BASE_DIR, "data", "mseth", "convex_snapshot.csv"), "w", newline=""
) as file:
    writer = csv.writer(file)
    writer.writerows(data)

with open(
    Path(BASE_DIR, "data", "mseth", "convex_overall.csv"), "w", newline=""
) as file:
    writer = csv.writer(file)
    writer.writerows(
        [
